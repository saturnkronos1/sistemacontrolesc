        ...
        if ($this->showFamilia) {
            if ($this->tipo_registro === 'padres') {
                $rules = array_merge($rules, [
                    ...
                    'p1_telefono_2' => 'nullable|digits:10',
                    ...
                    'p2_telefono' => 'nullable|digits:10',
                    'p2_telefono_2' => 'nullable|digits:10',
                ...
                $rules = array_merge($rules, [
                    ...
                    'tl_telefono' => 'nullable|digits:10',
                    'tl_telefono_2' => 'nullable|digits:10',
