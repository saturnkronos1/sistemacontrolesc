    ...
    {{-- <x-layouts::app.sidebar> --}}
        <flux:main>
            ...
            @if($cargado && $reporte === 'concentrado')
                                    ...
                                    <tr class="hover:bg-hover">
                                        ...
                                        @foreach($materias as $materia)
                                            <td class="px-4 py-3 text-center text-sm font-mono">
                                                ...
                                                @endphp
                                                @if($prom !== null)
                                                    <span class="{{ $prom >= 6 ? 'text-green-600 ' : 'text-red-600' }}">
                                        ...
                                        <td class="px-4 py-3 text-center text-sm font-mono font-semibold">
                                            @if(($promedios[$alumno['id']] ?? null) !== null)
                                                <span class="{{ $promedios[$alumno['id']] >= 6 ? 'text-green-600 ' : 'text-red-600' }}">
                ...
                @else
                    <div class="mb-6 rounded-lg border border-borde bg-white p-6 text-center text-sm text-zinc-500">
